...
namespace NanoTech
{
    ...
    public class CompNanoShieldSuit : ThingComp
    {
        ...
        public CompProperties_NanoShieldSuit Props => (CompProperties_NanoShieldSuit)props;
        ...
        private IEnumerable<Gizmo> GetGizmos()
        {
            ...
            {
                Gizmo_NanoShieldSuitStatus gizmo_EvoShieldStatus = new Gizmo_NanoShieldSuitStatus();
